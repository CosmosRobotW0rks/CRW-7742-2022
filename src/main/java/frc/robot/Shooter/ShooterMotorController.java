...
public class ShooterMotorController extends SubsystemBase {
    ...
    public VictorSPX ShooterMotor = new VictorSPX(15);
    ...
    public void UpdateMotor() {
        ...
        shooterPwr = Math.abs(targetRPS) >= 5 ? Math.max(Math.min(shooterPwr, 0.85), (targetRPS < 0 ? -0.85 : 0)) : 0;
    ...
    public void SetTargetRPS(double target_RPS) {
